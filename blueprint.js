...
function Tokens() {
  ...
  const getOpenSeaAssets = async () => {
    const res = await axios.get(
      // `https://api.opensea.io/api/v1/assets/?owner=0xccb74148d315b0397da4e3c7482036dbadd762e5`
      `https://api.opensea.io/api/v1/assets?asset_contract_address=0x03faa4f3c3b0653ce8ce9c16e2a3303478c2b67a&order_direction=asc`
    );
